...
import 'package:local_delivery_admin/screens/NotificationSettingScreen.dart';
...
List<StaticPaymentModel> getStaticPaymentItems() {
  ...
  list.add(StaticPaymentModel(title: language.pay_stack, type: PAYMENT_GATEWAY_PAYSTACK));
...
Map<String, dynamic> getAppSetting() {
  List<NotificationSettings> list = [];
  list.add(NotificationSettings(active: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(create: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(courier_assigned: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(courier_transfer: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(courier_arrived: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(delayed: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(cancelled: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(courier_picked_up: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(courier_departed: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(completed: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(payment_status_message: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
  list.add(NotificationSettings(failed: Notifications(iS_ONESIGNAL_NOTIFICATION: '0')));
