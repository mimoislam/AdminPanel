...
class DashboardModel {
  ...
  List<WeeklyOrderModel>? weekly_order_count;
  List<UserWeeklyModel>? user_weekly_count;
  ...
  factory DashboardModel.fromJson(Map<String, dynamic> json) {
    return DashboardModel(
      ...
      weekly_order_count: json['weekly_order_count'] != null ? (json['weekly_order_count'] as List).map((i) => WeeklyOrderModel.fromJson(i)).toList() : null,
      user_weekly_count: json['user_weekly_count'] != null ? (json['user_weekly_count'] as List).map((i) => UserWeeklyModel.fromJson(i)).toList() : null,
    );
  }
...
class WeeklyOrderModel {
  String? date;
  String? day;
  int? total;

  WeeklyOrderModel({this.date, this.day, this.total});

  factory WeeklyOrderModel.fromJson(Map<String, dynamic> json) {
    return WeeklyOrderModel(
      date: json['date'],
      day: json['day'],
      total: json['total'],
    );
...
class UserWeeklyModel {
  String? date;
  String? day;
  int? total;

  UserWeeklyModel({this.date, this.day, this.total});

  factory UserWeeklyModel.fromJson(Map<String, dynamic> json) {
    return UserWeeklyModel(
      date: json['date'],
      day: json['day'],
      total: json['total'],
    );
