...
class Notifications {
  String? iS_ONESIGNAL_NOTIFICATION;

  Notifications({this.iS_ONESIGNAL_NOTIFICATION});

  factory Notifications.fromJson(Map<String, dynamic> json) {
    return Notifications(
      iS_ONESIGNAL_NOTIFICATION: json['IS_ONESIGNAL_NOTIFICATION'],
    );
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['IS_ONESIGNAL_NOTIFICATION'] = this.iS_ONESIGNAL_NOTIFICATION;
    return data;
  }
}
