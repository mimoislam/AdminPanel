...
class WeeklyOrderCountComponent extends StatefulWidget {
  ...
  final List<WeeklyOrderModel> weeklyOrderCount;
    ...
    return Container(
      ...
      child: SfCircularChart(
        ...
        series: <CircularSeries>[
          PieSeries<WeeklyOrderModel, String>(
              dataSource: widget.weeklyOrderCount,
              xValueMapper: (WeeklyOrderModel data, _) => data.day,
              yValueMapper: (WeeklyOrderModel data, _) => data.total,
