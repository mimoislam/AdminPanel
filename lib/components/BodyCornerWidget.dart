    ...
    return Observer(builder: (context) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              Image.asset(appStore.isDarkMode ? 'assets/app_logo_white.png' : 'assets/ic_app_logo.jpg', height: 50, width: 50, fit: BoxFit.cover),
              SizedBox(width: 16),
          ...
          actions: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  children: [
                    Icon(Icons.logout, color: appStore.isDarkMode ? Colors.white : primaryColor),
                    SizedBox(width: 8),
                    Text(language.logout, style: primaryTextStyle(color: appStore.isDarkMode ? Colors.white : primaryColor)),
                  ],
                ),
              ),
            ),
